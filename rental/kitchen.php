...
// Fetch products for the tables category
$category = "tables";
$sql = "SELECT * FROM furniture WHERE category = '$category' ORDER BY id DESC";
...
<body>
    ...
    <div class="header">
        <h1>Welcome to the Furniture Rentals</h1>
        <p>Your one-stop destination for renting Furniture!</p>
    </div>
    ...
    <a href="add-furniture.html" class="add-button">+</a>
    <div class="footer">
        <div class="services">
            <div>
                <h3>Services</h3>
