...
// Fetch products for the cranes category
$category = "cranes";
$sql = "SELECT * FROM vehicles WHERE category = '$category' ORDER BY id DESC";
...
<body>
    ...
    <div class="header">
        ...
        <p>Your one-stop destination for renting Cranes!</p>
    </div>
    <div class="grid-container">
        <?php if ($result->num_rows > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p>No vehicles available in this category yet.</p>
        <?php endif; ?>
    </div>
    <a href="add-vehicle.html" class="add-button">+</a>
    <div class="footer">
        <div class="services">
            <div>
                <h3>Services</h3>
