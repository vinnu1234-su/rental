...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['product-image']) && $_FILES['product-image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($fileTmpPath, $uploadPath)) {
            ...
            $sql = "INSERT INTO products (name, description, price, category, additional_details, image_path) 
                    VALUES ('$productName', '$productDescription', $productPrice, '$productCategory', '$additionalDetails', '$uploadPath')";
            ...
            if ($conn->query($sql) === TRUE) {
                ...
                echo "<a href='add-product.html' style='color: #ffcc00;'>Add Another Product</a>";
            } else {
